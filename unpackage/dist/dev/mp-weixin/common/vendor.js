...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"wxapp_axios","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!************************************************!*\
  !*** D:/A-代码/A-uniApp小程序/wadd_kyzs/pages.json ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!****************************************************!*\
  !*** D:/A-代码/A-uniApp小程序/wadd_kyzs/utils/utils.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _typeof2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/typeof */ 13));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _class = __webpack_require__(/*! ../class/class */ 34);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
//导入公共类
var utils = {
  ...
  checkFuncs: {
    ...
    checkLogin: function checkLogin() {
      ...
      if (!us) {
        flag = false;
        utils.uniFuncs.uniModal("您还未登录，需要先去登录吗", function (res) {
    ...
    //检查是否存在用户缓存数据 */
    checkUsInfo: function checkUsInfo() {
      var flag = true,
        us = uni.getStorageSync('userInfo');
      flag = us ? us : false;
      return flag;
    ...
    //表单验证
    checkForm: function checkForm(value, type) {
      ...
      if (!value) {
        msg = "\u8BF7\u586B\u5199".concat(type_name);
        code = 0;
      } else if (!reg.test(value)) {
        msg = "".concat(type_name, "\u683C\u5F0F\u4E0D\u6B63\u786E");
        code = 0;
      }
      return {
        code: code,
  ...
  uniFuncs: {
    ...
    uniModal: function uniModal(modal_obj, confirmFn, cancelFn) {
      var default_modal_obj = {
        title: "温馨提示",
        content: "这是一个弹窗框",
        showCancel: true,
        cancelText: "取消",
      ...
      uni.showModal(_objectSpread(_objectSpread({}, default_modal_obj), {}, {
    ...
    //toast提示框
    uniToast: function uniToast(title) {
    ...
    //动态设置页面标题
    uniSetNavTitle: function uniSetNavTitle() {
    ...
    //设置系统剪贴板的内容
    uniSetClipboardData: function uniSetClipboardData(text) {
      var data = text;
    ...
    //快速拨打电话
    uniMakePhoneCall: function uniMakePhoneCall(phoneNumber) {
      var isString = typeof phoneNumber == 'string';
      if (!isString) {
    ...
    //获取用户地理位置授权弹窗
    uniGetLocation: function uniGetLocation() {
      return new Promise(function (resolve, reject) {
        uni.getLocation({
          type: "gcj02",
          success: function success(res) {
    ...
    uniAuthorize: function uniAuthorize() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "userLocation";
      var authType = {
        userLocation: function userLocation() {
          var _SCOPE = "scope.userLocation";
          return _SCOPE;
        }
      };
      var scope = authType[type]();
      return new Promise(function (resolve, reject) {
        uni.authorize({
          scope: scope,
          success: function success(res) {
    ...
    //清除全部缓存数据
    uniClearAllStoSync: function uniClearAllStoSync() {
      try {
    ...
    //存储缓存
    uniSetSotrageSycn: function uniSetSotrageSycn(storage_key, storage_data) {
      uni.setStorageSync(storage_key, storage_data);
    },
    //清除指定storage_key缓存
    uniRemoveStorageSync: function uniRemoveStorageSync(storage_key) {
      uni.removeStorageSync(storage_key);
    },
    //获取缓存内容=>默认获取缓存接口名数组
    uniGetStorageSync: function uniGetStorageSync() {
      var storage_key = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "pendingAjax";
      return uni.getStorageSync(storage_key);
    },
    //分享-生命周期onShareAppMessage封装
    uniOnShareMessage: function uniOnShareMessage(share_params, url, url_params) {
      var path = utils.handleObjFuncs.urlJoin(url, url_params);
      var SHAREOBJ = Object.assign(share_params, {
        path: path
      });
      return SHAREOBJ;
    },
    //选择图片上传的封装
    uniChooseImage: function uniChooseImage() {
      var count = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      var sizeType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ["compressed"];
      var sourceType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      return new Promise(function (resolve, reject) {
        uni.chooseImage({
          count: count,
          //默认1,单图上传
          ...
          //从相册选择
          success: function success(res) {
            var fileLength = res.tempFilePaths.length; //文件数组长度
            var tempFilePaths = res.tempFilePaths; //当前文件临时路径
            var tempFiles = res.tempFiles; //文件
            var file_obj = {
  ...
  handleObjFuncs: {
    ...
    replaceNull: function replaceNull(obj) {
    ...
    deepClone: function deepClone(obj) {
      ...
      var cloneObj = isArray ? (0, _toConsumableArray2.default)(obj) : _objectSpread({}, obj);
      Reflect.ownKeys(cloneObj).forEach(function (key) {
        cloneObj[key] = isObject(obj[key]) ? utils.handleObjFuncs.deepClone(obj[key]) : obj[key];
      });
      return cloneObj;
    },
    //删除对象中的
    delectObjKey: function delectObjKey(obj, key) {
      delete obj[key];
      return obj;
    },
    //链接自动合并传递参数
    urlJoin: function urlJoin(url, url_params) {
      url = new _class.checkRouterParams(url, url_params);
      return url;
    }
  },
  /* 页面处理方法 */
  commFuncs: {
    ...
    createPrePageData: function createPrePageData(pre_page_data) {
    ...
    getPrePageData: function getPrePageData(pre_data) {
  ...
  removeAjaxStorage: {
    //清除pendingAjax缓存
    removePendingStorage: function removePendingStorage() {
      var storage_key = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "pendingAjax";
      var pendingAjax = utils.uniFuncs.uniGetStorageSync(storage_key),
        pending_len = pendingAjax.length;
      if (!pending_len) return;
      utils.uniFuncs.uniRemoveStorageSync(storage_key);
      for (var i = 0; i < pending_len; i++) {
...
/* 34 */
/*!****************************************************!*\
  !*** D:/A-代码/A-uniApp小程序/wadd_kyzs/class/class.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.checkRouterParams = void 0;
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
/* 路径参数拼接公共类 */
var checkRouterParams = /*#__PURE__*/(0, _createClass2.default)(function checkRouterParams(url, jump_params, jump_type) {
  (0, _classCallCheck2.default)(this, checkRouterParams);
  var URL_FLAG = url.indexOf("?") == -1;
  var keys_arr = Object.keys(jump_params);
  var keys_length = keys_arr.length;
  var accType;
  ...
  for (var i = keys_length; i--;) {
    var routerKey = [keys_arr[i]];
    var routerVla = jump_params[keys_arr[i]];
    URL_FLAG ? accType = i == keys_length - 1 ? '?' : '&' : accType = '&';
    url = "".concat(url + accType + routerKey + '=' + routerVla);
  }
  return {
    url: url
  };
});
exports.checkRouterParams = checkRouterParams;

/***/ }),
/* 35 */
/*!***************************************************************!*\
  !*** D:/A-代码/A-uniApp小程序/wadd_kyzs/static/routers/routers.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
//https://node.web.huangmaorui.cn/
//打开以上链接，选中pages.json,自动生成文件内容
var routes = {};
var _default = routes;
exports.default = _default;
...
/* 36 */
/*!****************************************************!*\
  !*** D:/A-代码/A-uniApp小程序/wadd_kyzs/store/index.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
